[README.md](https://github.com/user-attachments/files/28343052/README.md)
# Flashcards-Quiz-Generator
A text-based Flashcards &amp; Quiz Generator that allows users to create, edit, and study flashcards. It includes multiple quiz modes and a simple menu-driven interface.**Project Name:**  
QuizBrains
